...
alias ls=lsd
alias grep=rg
alias l='lsd -lah --config-file /mnt/c/Users/tim/AppData/Roaming/lsd/config.yaml'
alias s='source ~/.bashrc'
alias c=clear
alias gst='git status'
alias rgi='rg --ignore-case'
alias cat='batcat --theme "One Dark"'
...
__conda_setup="$('/home/tim/mambaforge/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
