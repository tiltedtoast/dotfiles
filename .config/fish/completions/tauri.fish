...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s v -l verbose -d 'Enables verbose logging'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s h -l help -d 'Print help'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s V -l version -d 'Print version'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "init" -d 'Initialize a Tauri project in an existing directory'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "dev" -d 'Run your app in development mode'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "build" -d 'Build your app in release mode and generate bundles and installers'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "bundle" -d 'Generate bundles and installers for your app (already built by `tauri build`)'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "android" -d 'Android commands'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "migrate" -d 'Migrate from v1 to v2'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "info" -d 'Show a concise list of information about the environment, Rust, Node.js and their versions as well as a few relevant project configurations'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "add" -d 'Add a tauri plugin to the project'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "plugin" -d 'Manage or create Tauri plugins'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "icon" -d 'Generate various icons for all major platforms'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "signer" -d 'Generate signing keys for Tauri updater or sign files'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "completions" -d 'Generate Tauri CLI shell completions for Bash, Zsh, PowerShell or Fish'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "permission" -d 'Manage or create permissions for your app or plugin'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "capability" -d 'Manage or create capabilities for your app'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from build" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from bundle" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from add" -l no-fmt -d 'Don\'t format code with rustfmt'
...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s v -l verbose -d 'Enables verbose logging'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s h -l help -d 'Print help'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s V -l version -d 'Print version'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "wix-upgrade-code" -d 'Print the default Upgrade Code used by MSI installer derived from productName'
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c cargo -n "__fish_cargo_using_subcommand tauri; and __fish_seen_subcommand_from help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c cargo -n "__fish_cargo_using_subcommand help; and __fish_seen_subcommand_from tauri" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s v -l verbose -d 'Enables verbose logging'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s h -l help -d 'Print help'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s V -l version -d 'Print version'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "init" -d 'Initialize a Tauri project in an existing directory'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "dev" -d 'Run your app in development mode'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "build" -d 'Build your app in release mode and generate bundles and installers'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "bundle" -d 'Generate bundles and installers for your app (already built by `tauri build`)'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "android" -d 'Android commands'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "migrate" -d 'Migrate from v1 to v2'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "info" -d 'Show a concise list of information about the environment, Rust, Node.js and their versions as well as a few relevant project configurations'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "add" -d 'Add a tauri plugin to the project'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "plugin" -d 'Manage or create Tauri plugins'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "icon" -d 'Generate various icons for all major platforms'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "signer" -d 'Generate signing keys for Tauri updater or sign files'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "completions" -d 'Generate Tauri CLI shell completions for Bash, Zsh, PowerShell or Fish'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "permission" -d 'Manage or create permissions for your app or plugin'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "capability" -d 'Manage or create capabilities for your app'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from build" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from bundle" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from add" -l no-fmt -d 'Don\'t format code with rustfmt'
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s v -l verbose -d 'Enables verbose logging'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s h -l help -d 'Print help'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s V -l version -d 'Print version'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "wix-upgrade-code" -d 'Print the default Upgrade Code used by MSI installer derived from productName'
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c pnpm -n "__fish_pnpm_using_subcommand tauri; and __fish_seen_subcommand_from help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c pnpm -n "__fish_pnpm_using_subcommand help; and __fish_seen_subcommand_from tauri" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c npm -n "__fish_npm_using_subcommand run; and __fish_seen_subcommand_from tauri" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s v -l verbose -d 'Enables verbose logging'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s h -l help -d 'Print help'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -s V -l version -d 'Print version'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "init" -d 'Initialize a Tauri project in an existing directory'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "dev" -d 'Run your app in development mode'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "build" -d 'Build your app in release mode and generate bundles and installers'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "bundle" -d 'Generate bundles and installers for your app (already built by `tauri build`)'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "android" -d 'Android commands'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "migrate" -d 'Migrate from v1 to v2'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "info" -d 'Show a concise list of information about the environment, Rust, Node.js and their versions as well as a few relevant project configurations'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "add" -d 'Add a tauri plugin to the project'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "plugin" -d 'Manage or create Tauri plugins'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "icon" -d 'Generate various icons for all major platforms'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "signer" -d 'Generate signing keys for Tauri updater or sign files'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "completions" -d 'Generate Tauri CLI shell completions for Bash, Zsh, PowerShell or Fish'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "permission" -d 'Manage or create permissions for your app or plugin'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "capability" -d 'Manage or create capabilities for your app'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and not __fish_seen_subcommand_from init dev build bundle android migrate info add plugin icon signer completions permission capability inspect help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from build" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from bundle" -s b -l bundles -d 'Space or comma separated list of bundles to package' -r -f -a "{deb\t'',rpm\t'',appimage\t'',updater\t''}"
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from add" -l no-fmt -d 'Don\'t format code with rustfmt'
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s v -l verbose -d 'Enables verbose logging'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s h -l help -d 'Print help'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -s V -l version -d 'Print version'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "wix-upgrade-code" -d 'Print the default Upgrade Code used by MSI installer derived from productName'
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from inspect" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c yarn -n "__fish_yarn_using_subcommand tauri; and __fish_seen_subcommand_from help" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c yarn -n "__fish_yarn_using_subcommand help; and __fish_seen_subcommand_from tauri" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
...
complete -c bun -n "__fish_bun_using_subcommand run; and __fish_seen_subcommand_from tauri" -f -a "inspect" -d 'Manage or create permissions for your app or plugin'
